...
- Аккаунты: создание группы — исправлена отправка списка участников (400 Bad Request при выборе участников).
- Аккаунты: список участников в модальном окне групп обновляется без перезагрузки страницы.

### Улучшено
- Аккаунты: в модальном окне создания роли добавлен поиск по правам и увеличена ширина окна.
- Аккаунты: кнопки действий для групп/ролей переведены на текстовый вид (редактировать/удалить/сохранить/отмена).
- RBAC: роль `analyst` получила доступ к просмотру мониторинга.
