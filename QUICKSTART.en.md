...
## 3. Verify
- UI: `http://localhost:8080/login` (without reverse proxy) or `https://localhost/login` (if you started with `docker compose --profile proxy ...`, self-signed certs are stored in `TLS_CERTS_PATH`).
