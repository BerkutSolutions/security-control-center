...
- Шаблон message уведомлений мониторинга: [`docs/ru/monitoring_notifications_message_template.md`](docs/ru/monitoring_notifications_message_template.md)
- Проверка состояния (/healthcheck): [`docs/ru/healthcheck.md`](docs/ru/healthcheck.md)
