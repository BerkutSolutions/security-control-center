...
type routeHandlers struct {
	...
	servicesCatalog        *handlers.ServicesCatalogHandler
	tagsCatalog            *handlers.TagsCatalogHandler
	classificationsCatalog *handlers.ClassificationsCatalogHandler
	notificationsSettings  *handlers.NotificationsSettingsHandler
...
func (s *Server) newRouteHandlers() routeHandlers {
	...
	return routeHandlers{
		...
		runtime:                handlers.NewRuntimeSettingsHandler(s.cfg, s.appModules, s.appRuntimeStore, s.updateChecker, s.audits),
		...
		hardening:              handlers.NewHardeningHandler(s.cfg, s.appModules, s.appHTTPSStore, s.appRuntimeStore, s.behaviorRiskStore, s.users, s.audits),
		docs:                   handlers.NewDocsHandler(s.cfg, s.docsStore, s.entityLinksStore, s.controlsStore, s.assetsStore, s.softwareStore, s.users, s.appModules, s.policy, s.docsSvc, s.behaviorRiskStore, s.audits, s.logger),
		reports:                handlers.NewReportsHandler(s.cfg, s.appModules, s.docsStore, s.reportsStore, s.users, s.policy, s.docsSvc, s.incidentsStore, s.incidentsSvc, s.controlsStore, s.monitoringStore, s.tasksSvc, s.behaviorRiskStore, s.audits, s.logger),
		...
		servicesCatalog:        handlers.NewServicesCatalogHandler(s.appModules, s.audits),
		tagsCatalog:            handlers.NewTagsCatalogHandler(s.appModules, s.audits),
		classificationsCatalog: handlers.NewClassificationsCatalogHandler(s.appModules, s.audits),
		notificationsSettings:  handlers.NewNotificationsSettingsHandler(s.appModules, s.audits, s.monitoringStore, s.monitoringEngine, s.incidentsSvc.Encryptor()),
