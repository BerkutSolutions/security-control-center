...
func (s *Server) registerCoreAPIRoutes(apiRouter chi.Router, h routeHandlers) {
	...
	apiRouter.MethodFunc("GET", "/auth/stepup/status", s.withSession(s.StepupStatus))
	apiRouter.MethodFunc("POST", "/auth/stepup/password", s.withSession(s.StepupVerifyPassword))
	apiRouter.MethodFunc("POST", "/auth/stepup/totp", s.withSession(s.StepupVerifyTOTP))
	apiRouter.MethodFunc("POST", "/auth/stepup/passkey/begin", s.withSession(s.StepupPasskeyBegin))
	apiRouter.MethodFunc("POST", "/auth/stepup/passkey/finish", s.withSession(s.StepupPasskeyFinish))
