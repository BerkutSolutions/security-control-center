...
var roles = []Role{
	...
	{Name: "analyst", Permissions: []Permission{"app.view", "dashboard.view", "docs.view", "controls.view", "controls.checks.view", "controls.violations.view", "controls.frameworks.view", "assets.view", "software.view", "monitoring.view", "monitoring.events.view", "tasks.view", "tasks.create", "tasks.edit", "tasks.comment", "findings.view", "incidents.view"}},
}
