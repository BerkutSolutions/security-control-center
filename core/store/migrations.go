...
func ApplyMigrations(ctx context.Context, db *sql.DB, logger *utils.Logger) error {
	if logger != nil {
		logger.Printf("applying migrations")
	}
	...
	if err := ensureDocsColumns(ctx, db); err != nil {
		return err
	}
	if err := ensureApprovalColumns(ctx, db); err != nil {
		return err
	}
	if err := ensureApprovalParticipantsSchema(ctx, db); err != nil {
		return err
	}
	if err := ensureRoleColumns(ctx, db); err != nil {
		return err
	}
	if err := ensureSessionColumns(ctx, db); err != nil {
		return err
	}
	if err := ensureMonitoringColumns(ctx, db); err != nil {
		return err
	}
	if err := ensureGroupColumns(ctx, db); err != nil {
		return err
	}
	if err := ensureIncidentColumns(ctx, db); err != nil {
		return err
	}
	if err := ensureIncidentStageColumns(ctx, db); err != nil {
		return err
	}
	if err := ensureIncidentLinkColumns(ctx, db); err != nil {
		return err
	}
	if err := ensureIncidentTimelineColumns(ctx, db); err != nil {
		return err
	}
	if err := ensureIncidentArtifactFiles(ctx, db); err != nil {
		return err
	}
	if err := ensureEntityLinksSchema(ctx, db); err != nil {
		return err
	}
	if err := ensureControlTypes(ctx, db); err != nil {
		return err
	}
	if err := ensureControlViolationColumns(ctx, db); err != nil {
		return err
	}
	if err := ensureTaskCommentColumns(ctx, db); err != nil {
		return err
	}
	if err := ensureTaskColumns(ctx, db); err != nil {
		return err
	}
	if err := ensureTaskBoardColumns(ctx, db); err != nil {
		return err
	}
	if err := ensureTaskColumnColumns(ctx, db); err != nil {
		return err
	}
	if err := ensureTaskSpaceBackfill(ctx, db); err != nil {
		return err
	}
	if err := ensureTaskBoardSpaceGuards(ctx, db); err != nil {
		return err
	}
	return nil
}
