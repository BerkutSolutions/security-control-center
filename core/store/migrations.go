...
var migrations = []string{
	...
	`CREATE TABLE IF NOT EXISTS asset_software (
		...
		FOREIGN KEY(product_id) REFERENCES software_products(id) ON DELETE CASCADE,
		FOREIGN KEY(version_id) REFERENCES software_versions(id) ON DELETE SET NULL
	);`,
...
func ensureMonitoringColumns(ctx context.Context, db *sql.DB) error {
	...
	cols := []col{
		...
		{Table: "monitor_state", Name: "retry_at", SQL: "ALTER TABLE monitor_state ADD COLUMN retry_at TIMESTAMP"},
		{Table: "monitor_state", Name: "retry_attempt", SQL: "ALTER TABLE monitor_state ADD COLUMN retry_attempt INTEGER NOT NULL DEFAULT 0"},
		{Table: "monitor_state", Name: "last_attempt_at", SQL: "ALTER TABLE monitor_state ADD COLUMN last_attempt_at TIMESTAMP"},
		...
		{Table: "monitoring_settings", Name: "log_dns_events", SQL: "ALTER TABLE monitoring_settings ADD COLUMN log_dns_events INTEGER NOT NULL DEFAULT 1"},
		...
		{Table: "monitoring_settings", Name: "auto_incident_close_on_up", SQL: "ALTER TABLE monitoring_settings ADD COLUMN auto_incident_close_on_up INTEGER NOT NULL DEFAULT 0"},
