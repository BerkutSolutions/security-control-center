...
ALTER TABLE users ADD COLUMN IF NOT EXISTS clearance_level INTEGER NOT NULL DEFAULT 0;
...
ALTER TABLE task_boards ADD COLUMN IF NOT EXISTS space_id INTEGER NOT NULL DEFAULT 0;
ALTER TABLE task_boards ADD COLUMN IF NOT EXISTS position INTEGER NOT NULL DEFAULT 0;
...
INSERT OR IGNORE INTO control_types(name, is_builtin, created_at) VALUES('organizational', 1, CURRENT_TIMESTAMP);
INSERT OR IGNORE INTO control_types(name, is_builtin, created_at) VALUES('technical', 1, CURRENT_TIMESTAMP);
INSERT OR IGNORE INTO control_types(name, is_builtin, created_at) VALUES('procedural', 1, CURRENT_TIMESTAMP);
