...
- `BERKUT_AUDIT_SIGNING_KEY` (required outside `APP_ENV=dev`, minimum 32 chars)
...
Audit:
- Forensic package export: `GET /api/logs/export/package` (zip: `audit_events.jsonl`, `manifest.json`, `checksums.sha256`, `manifest.signature`)
