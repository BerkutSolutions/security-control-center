...
Актуальная версия документации: `1.2.2`
...
- Accesses: добавлена вкладка `Доступы` (карточки пользователей, редактирование, дополнение сервисов, история изменений, блокировка/разблокировка).

- Settings: добавлена вкладка `Сервисы` (справочник сервисов для вкладки `Доступы`).
