const LogsPage = (() => {
  ...
  function categoryForAction(action) {
    ...
    if (action.startsWith('registry.')) return 'controls';
    if (action.startsWith('controls.')) return 'controls';
    if (action.startsWith('control.')) return 'controls';
    if (action.startsWith('assets.')) return 'assets';
    if (action.startsWith('finding.')) return 'findings';
    if (action.startsWith('software.') || action.startsWith('assets.software.')) return 'software';
  ...
  const ACTION_LABELS = {
    ru: {
      ...
      'auth.2fa.enable': 'Авторизация: 2FA включена',
      'auth.2fa.disable': 'Авторизация: 2FA выключена',
      'auth.2fa.challenge.fail': 'Авторизация: ошибка 2FA',
      'auth.2fa.recovery.used': 'Авторизация: recovery code использован',
      'auth.passkey.register.begin': 'Авторизация: passkey (начало регистрации)',
      'auth.passkey.create': 'Авторизация: passkey добавлен',
      'auth.passkey.rename': 'Авторизация: passkey переименован',
      'auth.passkey.delete': 'Авторизация: passkey удалён',
      'auth.passkey.login_success': 'Авторизация: вход по passkey',
      'auth.passkey.login_failed': 'Авторизация: ошибка входа по passkey',
      'auth.passkey.2fa.used': 'Авторизация: passkey как 2FA',
      'security.ssrf.blocked': 'Безопасность: SSRF блокировка',
      ...
      'registry.tab.overview.view': 'Реестры: обзор',
      'registry.tab.controls.view': 'Реестры: контроли',
      'registry.tab.checks.view': 'Реестры: проверки',
      'registry.tab.violations.view': 'Реестры: нарушения',
      'registry.tab.frameworks.view': 'Реестры: фреймворки',
      'registry.tab.assets.view': 'Реестры: активы',
      'registry.tab.software.view': 'Реестры: ПО',
      'registry.tab.findings.view': 'Реестры: замечания',
      'assets.create': 'Активы: создание',
      'assets.update': 'Активы: обновление',
      'assets.archive': 'Активы: архивирование',
      'assets.restore': 'Активы: восстановление',
      'assets.export.csv': 'Активы: экспорт CSV',
      'assets.software.view': 'ПО на активе: просмотр',
      'assets.software.add': 'ПО на активе: добавление',
      'assets.software.update': 'ПО на активе: обновление',
      'assets.software.archive': 'ПО на активе: архивирование',
      'assets.software.restore': 'ПО на активе: восстановление',
      'software.create': 'ПО: создание продукта',
      'software.update': 'ПО: обновление продукта',
      'software.archive': 'ПО: архивирование продукта',
      'software.restore': 'ПО: восстановление продукта',
      'software.version.create': 'ПО: создание версии',
      'software.version.update': 'ПО: обновление версии',
      'software.version.archive': 'ПО: архивирование версии',
      'software.version.restore': 'ПО: восстановление версии',
      'software.export.csv': 'ПО: экспорт CSV',
      'finding.create': 'Находки: создание',
      'finding.update': 'Находки: обновление',
      'finding.archive': 'Находки: архивирование',
      'finding.restore': 'Находки: восстановление',
      'finding.link.add': 'Находки: добавление связи',
      'finding.link.remove': 'Находки: удаление связи',
      'finding.export.csv': 'Находки: экспорт CSV',
      ...
      'incident.cleanup': 'Инциденты: массовая очистка',
      ...
      'monitoring.monitor.assets.set': 'Мониторинг: активы монитора изменены',
      ...
      'monitoring.notification.channel.reveal_token': 'Мониторинг: раскрытие токена канала уведомлений',
      ...
      'notifications.settings.update': 'Уведомления: настройки обновлены',
      'notifications.settings.view': 'Уведомления: просмотр настроек',
      'notifications.accesses.send': 'Уведомления: отправка события доступов',
      'accesses.update': 'Доступы: сохранение изменений',
      'accesses.create': 'Доступы: создание доступа',
      'accesses.edit': 'Доступы: редактирование доступа',
      'accesses.supplement': 'Доступы: дополнение сервисов',
      'accesses.blocked': 'Доступы: блокировка доступа',
      'accesses.unblocked': 'Доступы: разблокировка доступа',
      'accesses.delete': 'Доступы: удаление доступа',
      'accesses.dismissal': 'Доступы: увольнение сотрудника',
      'accesses.test': 'Доступы: тест уведомления',
      'accesses.cleanup': 'Доступы: системная синхронизация',
      'services.catalog.update': 'Настройки: каталог сервисов обновлен',
      'tags.catalog.update': 'Настройки: каталог тегов обновлен',
      'classifications.catalog.update': 'Настройки: классификации обновлены',
    ...
    en: {
      ...
      'auth.2fa.enable': 'Authentication: 2FA enabled',
      'auth.2fa.disable': 'Authentication: 2FA disabled',
      'auth.2fa.challenge.fail': 'Authentication: 2FA challenge failed',
      'auth.2fa.recovery.used': 'Authentication: recovery code used',
      'auth.passkey.register.begin': 'Authentication: passkey (registration begin)',
      'auth.passkey.create': 'Authentication: passkey added',
      'auth.passkey.rename': 'Authentication: passkey renamed',
      'auth.passkey.delete': 'Authentication: passkey deleted',
      'auth.passkey.login_success': 'Authentication: passkey login success',
      'auth.passkey.login_failed': 'Authentication: passkey login failed',
      'auth.passkey.2fa.used': 'Authentication: passkey used as 2FA',
      'security.ssrf.blocked': 'Security: SSRF blocked',
      ...
      'registry.tab.overview.view': 'Registries: overview',
      'registry.tab.controls.view': 'Registries: controls',
      'registry.tab.checks.view': 'Registries: checks',
      'registry.tab.violations.view': 'Registries: violations',
      'registry.tab.frameworks.view': 'Registries: frameworks',
      'registry.tab.assets.view': 'Registries: assets',
      'registry.tab.software.view': 'Registries: software',
      'registry.tab.findings.view': 'Registries: remarks',
      'assets.create': 'Assets: create',
      'assets.update': 'Assets: update',
      'assets.archive': 'Assets: archive',
      'assets.restore': 'Assets: restore',
      'assets.export.csv': 'Assets: export CSV',
      'assets.software.view': 'Asset software: view',
      'assets.software.add': 'Asset software: add',
      'assets.software.update': 'Asset software: update',
      'assets.software.archive': 'Asset software: archive',
      'assets.software.restore': 'Asset software: restore',
      'software.create': 'Software: create product',
      'software.update': 'Software: update product',
      'software.archive': 'Software: archive product',
      'software.restore': 'Software: restore product',
      'software.version.create': 'Software: create version',
      'software.version.update': 'Software: update version',
      'software.version.archive': 'Software: archive version',
      'software.version.restore': 'Software: restore version',
      'software.export.csv': 'Software: export CSV',
      'finding.create': 'Findings: create',
      'finding.update': 'Findings: update',
      'finding.archive': 'Findings: archive',
      'finding.restore': 'Findings: restore',
      'finding.link.add': 'Findings: link added',
      'finding.link.remove': 'Findings: link removed',
      'finding.export.csv': 'Findings: export CSV',
      ...
      'incident.cleanup': 'Incidents: bulk cleanup',
      ...
      'monitoring.monitor.assets.set': 'Monitoring: monitor assets updated',
      ...
      'monitoring.notification.channel.reveal_token': 'Monitoring: notification channel token revealed',
      ...
      'notifications.settings.update': 'Notifications: settings updated',
      'notifications.settings.view': 'Notifications: settings viewed',
      'notifications.accesses.send': 'Notifications: access event send',
      'accesses.update': 'Accesses: changes saved',
      'accesses.create': 'Accesses: create',
      'accesses.edit': 'Accesses: edit',
      'accesses.supplement': 'Accesses: supplement services',
      'accesses.blocked': 'Accesses: blocked',
      'accesses.unblocked': 'Accesses: unblocked',
      'accesses.delete': 'Accesses: delete',
      'accesses.dismissal': 'Accesses: dismissal event',
      'accesses.test': 'Accesses: notification test',
      'accesses.cleanup': 'Accesses: system sync',
      'services.catalog.update': 'Settings: services catalog updated',
      'tags.catalog.update': 'Settings: tags catalog updated',
      'classifications.catalog.update': 'Settings: classifications updated',
